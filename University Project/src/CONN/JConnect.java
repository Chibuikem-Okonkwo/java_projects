...
public class JConnect {
    ...
    public Connection getNewConnection() {
        ...
        String connectionString = "jdbc:mysql://localhost:3306/university_db";   //java database connection **connection parameters
        String driver = "com.mysql.jdbc.Driver";     //mysql driver
        String userName = "root", password = "Beaconhills23";
        try {
